...
(function ($){   
    ...
    $.ageCheck = function(options) {
        ...
        var settings = $.extend({
            ...
            copy : 'You must be 18 or older to enter'
        }, options);
        ...
        var _this = {
            ...
            handleSuccess : function(){                
                var successMsg = '<h3>Success!</h3><p>You are now being redirected...</p>';
            ...
            handleUnderAge : function() {
                var underAgeMsg = '<h3>Sorry, you are not old enough to view this content...</h3>';
